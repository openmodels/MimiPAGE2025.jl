...
@defcomp NonMarketDamages begin
    ...
    config_nonmarketdmg = Parameter{String}()
    ...
    function run_timestep(p, v, d, t)
        if p.config_nonmarketdmg == "none"
            v.i_regionalimpact[t, :] .= 0.
            v.iref_ImpactatReferenceGDPperCap[t, :] .= 0.
            v.igdp_ImpactatActualGDPperCap[t, :] .= 0.
            ...
            for cc in d.country
                ...
                if p.config_nonmarketdmg == "pinational"
                ...
                v.igdp_ImpactatActualGDPperCap[t,cc] = v.iref_ImpactatReferenceGDPperCap[t,cc] *
                    (max(p.rgdp_per_cap_MarketRemainGDP[t,cc], 0.) / p.GDP_per_cap_focus_0_FocusRegionEU)^p.ipow_NonMarketIncomeFxnExponent
...
function addnonmarketdamages(model::Model, use_page09weights::Bool=false; config_nonmarketdmg::String="default")
    ...
    nonmarketdamagescomp[:config_nonmarketdmg] = config_nonmarketdmg
    if config_nonmarketdmg == "pinational"

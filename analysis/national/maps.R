...
scc.map("output/allscc-2050-v2.csv", "Pulse in 2050", "-2050")
scc.map("output/allscc-2100-v2.csv", "Pulse in 2100", "-2100")
...
scc.map("output/allscc-nosubnational.csv", "National-only Effects", "-nosubnational")
